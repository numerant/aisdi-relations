...
AisdiRelationsFrame::AisdiRelationsFrame(wxWindow* parent,wxWindowID id)
{
    ...
    PanelStatistics = new wxPanel(PanelMain, ID_PANEL5, wxPoint(0,0), wxSize(1366,768), wxTAB_TRAVERSAL, _T("ID_PANEL5"));
    ...
    PanelGroups = new wxPanel(PanelMain, ID_PANEL6, wxPoint(0,0), wxSize(1366,768), wxTAB_TRAVERSAL, _T("ID_PANEL6"));
    ...
    PanelTree = new wxPanel(PanelMain, ID_PANEL7, wxPoint(0,0), wxSize(1366,768), wxTAB_TRAVERSAL, _T("ID_PANEL7"));
    BitmapBackgroundTree = new wxStaticBitmap(PanelTree, ID_STATICBITMAP6, wxBitmap(wxImage(_T("/home/panda/aisdi-relations2/bin/resources/background3.jpg")).Rescale(wxSize(1366,768).GetWidth(),wxSize(1366,768).GetHeight())), wxPoint(0,0), wxSize(1366,768), wxSIMPLE_BORDER, _T("ID_STATICBITMAP6"));
    PanelInbox = new wxPanel(PanelMain, ID_PANEL2, wxPoint(0,0), wxSize(1366,768), wxTRANSPARENT_WINDOW|wxTAB_TRAVERSAL, _T("ID_PANEL2"));
    BitmapBackgroundInbox = new wxStaticBitmap(PanelInbox, ID_STATICBITMAP1, wxBitmap(wxImage(_T("/home/panda/aisdi-relations/bin/resources/background3.jpg")).Rescale(wxSize(1366,768).GetWidth(),wxSize(1366,768).GetHeight())), wxPoint(0,0), wxSize(1366,768), wxSIMPLE_BORDER, _T("ID_STATICBITMAP1"));
    InboxBorder = new wxStaticBox(PanelInbox, ID_STATICBOX1, _("  Skrzynka Email  "), wxPoint(15,90), wxSize(570,610), 0, _T("ID_STATICBOX1"));
    ...
    Inbox = new wxListCtrl(PanelInbox, ID_LISTCTRL1, wxPoint(25,120), wxSize(550,570), wxLC_REPORT, wxDefaultValidator, _T("ID_LISTCTRL1"));
    ...
    EmailContentBorder = new wxStaticBox(PanelInbox, ID_STATICBOX2, wxEmptyString, wxPoint(650,93), wxSize(600,500), 0, _T("ID_STATICBOX2"));
    ...
    LabelFrom = new wxStaticText(PanelInbox, ID_STATICTEXT1, _("Od: "), wxPoint(670,120), wxDefaultSize, 0, _T("ID_STATICTEXT1"));
    ...
    LabelTo = new wxStaticText(PanelInbox, ID_STATICTEXT2, _("Do:"), wxPoint(670,145), wxDefaultSize, 0, _T("ID_STATICTEXT2"));
    ...
    LabelSubject = new wxStaticText(PanelInbox, ID_STATICTEXT5, _("Temat:"), wxPoint(670,170), wxDefaultSize, 0, _T("ID_STATICTEXT5"));
    ...
    LineContentSeparator = new wxStaticLine(PanelInbox, ID_STATICLINE1, wxPoint(665,210), wxSize(560,10), wxLI_HORIZONTAL, _T("ID_STATICLINE1"));
    HtmlEmailContent = new wxHtmlWindow(PanelInbox, ID_HTMLWINDOW1, wxPoint(670,230), wxSize(560,350), wxHW_SCROLLBAR_AUTO|wxNO_BORDER|wxTAB_TRAVERSAL, _T("ID_HTMLWINDOW1"));
    HtmlEmailContent->SetPage(_("<p align=\"justify\"><font color=\"white\">Donec pretium velit nisi, id euismod libero mattis sit amet. Quisque eu volutpat lectus. Nam lacus urna, tincidunt vitae convallis ut, commodo eget augue. Phasellus ornare lacus sapien, sit amet hendrerit neque scelerisque a. Praesent dapibus massa magna, vitae rhoncus turpis malesuada et. Nulla vel suscipit nunc. Integer metus turpis, consectetur non lacinia et, molestie sit amet velit.Donec pretium velit nisi, id euismod libero mattis sit amet. Quisque eu volutpat lectus. Nam lacus urna, tincidunt vitae convallis ut, commodo eget augue. Phasellus ornare lacus sapien, sit amet hendrerit neque scelerisque a. Praesent dapibus massa magna, vitae rhoncus turpis malesuada et. Nulla vel suscipit nunc. Integer metus turpis, consectetur non lacinia et, molestie sit amet velit.Donec pretium velit nisi, id euismod libero mattis sit amet. Quisque eu volutpat lectus. Nam lacus urna, tincidunt vitae convallis ut, commodo eget augue. Phasellus ornare lacus sapien, sit amet hendrerit neque scelerisque a. Praesent dapibus massa magna, vitae rhoncus turpis malesuada et. Nulla vel suscipit nunc. Integer metus turpis, consectetur non lacinia et, molestie sit amet velit.</font></p>"));
    HtmlEmailContent->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_WINDOW));
    HtmlEmailContent->SetBackgroundColour(wxColour(20,20,20));
    wxFont HtmlEmailContentFont(10,wxDEFAULT,wxFONTSTYLE_NORMAL,wxNORMAL,false,_T("Ubuntu"),wxFONTENCODING_DEFAULT);
    HtmlEmailContent->SetFont(HtmlEmailContentFont);
    StaticTextSubject = new wxStaticText(PanelInbox, ID_STATICTEXT6, _("a"), wxPoint(735,170), wxDefaultSize, 0, _T("ID_STATICTEXT6"));
    ...
    StaticTextTo = new wxStaticText(PanelInbox, ID_STATICTEXT4, _("b"), wxPoint(710,145), wxDefaultSize, 0, _T("ID_STATICTEXT4"));
    ...
    StaticTextFrom = new wxStaticText(PanelInbox, ID_STATICTEXT3, _("c"), wxPoint(710,120), wxDefaultSize, 0, _T("ID_STATICTEXT3"));
...
void AisdiRelationsFrame::ShowTitle (void ) {
    ...
    // Wyświetlenie tytułu aplikacji na głównym ekranie (w 3 częściach)
     ...
     wxStaticText*  Title1 = new wxStaticText(PanelInbox, 100, _("Analiza"), wxPoint(400,40), wxDefaultSize, 0, _T("ID_STATICTEXT1"));
     wxStaticText*  Title2 = new wxStaticText(PanelInbox, 101, _("Relacji"), wxPoint(500,120), wxDefaultSize, 0, _T("ID_STATICTEXT2"));
     wxStaticText*  Title3 = new wxStaticText(PanelInbox, 102, _("Biznesowych"), wxPoint(450,200), wxDefaultSize, 0, _T("ID_STATICTEXT3"));
     Title1->SetFont(font);
     Title2->SetFont(font);
     Title3->SetFont(font);
