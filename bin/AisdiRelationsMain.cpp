...
AisdiRelationsFrame::AisdiRelationsFrame(wxWindow* parent,wxWindowID id)
{
    ...
    S_BorderT = new wxStaticBox(S_PanelTops, ID_STATICBOX8, wxEmptyString, wxPoint(0,-10), wxSize(450,370), 0, _T("ID_STATICBOX8"));
    ...
    S_StaticTextT_ReceiversPos1 = new wxStaticText(S_PanelTops, ID_STATICTEXT118, _("1."), wxPoint(15,220), wxDefaultSize, 0, _T("ID_STATICTEXT118"));
    S_StaticTextT_ReceiversPos1->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_ACTIVECAPTION));
    S_StaticTextT_ReceiversPos2 = new wxStaticText(S_PanelTops, ID_STATICTEXT119, _("2."), wxPoint(15,245), wxDefaultSize, 0, _T("ID_STATICTEXT119"));
    S_StaticTextT_ReceiversPos2->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_SCROLLBAR));
    S_StaticTextT_ReceiversPos3 = new wxStaticText(S_PanelTops, ID_STATICTEXT120, _("3."), wxPoint(15,270), wxDefaultSize, 0, _T("ID_STATICTEXT120"));
    S_StaticTextT_ReceiversPos3->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_SCROLLBAR));
    S_StaticTextT_ReceiversPos4 = new wxStaticText(S_PanelTops, ID_STATICTEXT121, _("4."), wxPoint(15,295), wxDefaultSize, 0, _T("ID_STATICTEXT121"));
    S_StaticTextT_ReceiversPos4->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_SCROLLBAR));
    S_StaticTextT_ReceiversPos5 = new wxStaticText(S_PanelTops, ID_STATICTEXT122, _("5."), wxPoint(15,320), wxDefaultSize, 0, _T("ID_STATICTEXT122"));
    ...
    S_HyperLinkT_ReceiverPos1 = new wxHyperlinkCtrl(S_PanelTops, ID_HYPERLINKCTRL6, _("Superman <clarkkent@dailyplanet.com>"), wxEmptyString, wxPoint(40,220), wxDefaultSize, wxHL_ALIGN_LEFT|wxNO_BORDER|wxTRANSPARENT_WINDOW, _T("ID_HYPERLINKCTRL6"));
    ...
    S_HyperLinkT_ReceiverPos2 = new wxHyperlinkCtrl(S_PanelTops, ID_HYPERLINKCTRL7, _("Green Lantern <haljordan@willpower.com>"), wxEmptyString, wxPoint(40,245), wxDefaultSize, wxHL_ALIGN_LEFT|wxNO_BORDER|wxTRANSPARENT_WINDOW, _T("ID_HYPERLINKCTRL7"));
    ...
    S_HyperLinkT_ReceiverPos3 = new wxHyperlinkCtrl(S_PanelTops, ID_HYPERLINKCTRL8, _("Wonder Woman <diana@amazon.com>"), wxEmptyString, wxPoint(40,270), wxDefaultSize, wxHL_ALIGN_LEFT|wxNO_BORDER|wxTRANSPARENT_WINDOW, _T("ID_HYPERLINKCTRL8"));
    ...
    S_HyperLinkT_ReceiverPos4 = new wxHyperlinkCtrl(S_PanelTops, ID_HYPERLINKCTRL9, _("Flash <barryallen@paradox.com>"), wxEmptyString, wxPoint(40,295), wxDefaultSize, wxHL_ALIGN_LEFT|wxNO_BORDER|wxTRANSPARENT_WINDOW, _T("ID_HYPERLINKCTRL9"));
    ...
    S_HyperLinkT_ReceiverPos5 = new wxHyperlinkCtrl(S_PanelTops, ID_HYPERLINKCTRL10, _("Batman <brucewayne@gotham.com>"), wxEmptyString, wxPoint(40,320), wxDefaultSize, wxHL_ALIGN_LEFT|wxNO_BORDER|wxTRANSPARENT_WINDOW, _T("ID_HYPERLINKCTRL10"));
    ...
    PanelAdd = new wxPanel(PanelMain, ID_PANEL15, wxPoint(470,300), wxSize(360,110), wxNO_BORDER|wxTRANSPARENT_WINDOW|wxTAB_TRAVERSAL, _T("ID_PANEL15"));
    PanelAdd->SetBackgroundColour(wxColour(48,48,48));
    A_Border = new wxStaticBox(PanelAdd, ID_STATICBOX10, wxEmptyString, wxPoint(0,-10), wxSize(360,120), 0, _T("ID_STATICBOX10"));
    ...
    A_ImageButtonTxt = new wxBitmapButton(PanelAdd, ID_IMAGEBUTTON60, wxNullBitmap, wxPoint(280,10), wxSize(60,60), wxBU_AUTODRAW|wxNO_BORDER|wxTRANSPARENT_WINDOW|wxTAB_TRAVERSAL, wxDefaultValidator, _T("ID_IMAGEBUTTON60"));
    ...
    A_LabelTxt = new wxStaticText(PanelAdd, ID_STATICTEXT129, _("Plik .txt"), wxPoint(284,75), wxDefaultSize, wxALIGN_CENTRE|wxNO_BORDER|wxTRANSPARENT_WINDOW, _T("ID_STATICTEXT129"));
    A_LabelTxt->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_INACTIVECAPTION));
    wxFont A_LabelTxtFont(11,wxDEFAULT,wxFONTSTYLE_NORMAL,wxNORMAL,false,_T("Ubuntu"),wxFONTENCODING_DEFAULT);
    A_LabelTxt->SetFont(A_LabelTxtFont);
