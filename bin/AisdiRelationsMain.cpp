...
const long AisdiRelationsFrame::ID_STATICBOX16 = wxNewId();
const long AisdiRelationsFrame::ID_STATICBOX15 = wxNewId();
const long AisdiRelationsFrame::ID_PANEL19 = wxNewId();
...
const long AisdiRelationsFrame::ID_STATICBOX13 = wxNewId();
const long AisdiRelationsFrame::ID_STATICBOX14 = wxNewId();
const long AisdiRelationsFrame::ID_LISTCTRL5 = wxNewId();
const long AisdiRelationsFrame::ID_STATICTEXT154 = wxNewId();
const long AisdiRelationsFrame::ID_STATICTEXT156 = wxNewId();
const long AisdiRelationsFrame::ID_STATICTEXT155 = wxNewId();
const long AisdiRelationsFrame::ID_STATICTEXT157 = wxNewId();
const long AisdiRelationsFrame::ID_STATICTEXT159 = wxNewId();
const long AisdiRelationsFrame::ID_STATICTEXT158 = wxNewId();
const long AisdiRelationsFrame::ID_STATICLINE11 = wxNewId();
const long AisdiRelationsFrame::ID_LISTCTRL6 = wxNewId();
const long AisdiRelationsFrame::ID_PANEL18 = wxNewId();
...
const long AisdiRelationsFrame::ID_CHECKBOX5 = wxNewId();
...
const long AisdiRelationsFrame::idMenuAutoUpdate = wxNewId();
...
AisdiRelationsFrame::AisdiRelationsFrame(wxWindow* parent,wxWindowID id)
{
    ...
    M_BorderInfo = new wxStaticBox(PanelMulTree, ID_STATICBOX16, _("   Dane   "), wxPoint(870,100), wxSize(420,610), 0, _T("ID_STATICBOX16"));
    M_BorderInfo->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_ACTIVECAPTION));
    M_BorderInfo->SetBackgroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_ACTIVECAPTION));
    wxFont M_BorderInfoFont(16,wxDEFAULT,wxFONTSTYLE_NORMAL,wxNORMAL,false,_T("Ubuntu"),wxFONTENCODING_DEFAULT);
    M_BorderInfo->SetFont(M_BorderInfoFont);
    M_BorderTree = new wxStaticBox(PanelMulTree, ID_STATICBOX15, _("   Drzewo Multicastowe   "), wxPoint(15,100), wxSize(820,610), 0, _T("ID_STATICBOX15"));
    M_BorderTree->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_ACTIVECAPTION));
    M_BorderTree->SetBackgroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_ACTIVECAPTION));
    wxFont M_BorderTreeFont(16,wxDEFAULT,wxFONTSTYLE_NORMAL,wxNORMAL,false,_T("Ubuntu"),wxFONTENCODING_DEFAULT);
    M_BorderTree->SetFont(M_BorderTreeFont);
    M_PanelDraw = new wxPanel(PanelMulTree, ID_PANEL19, wxPoint(25,130), wxSize(800,570), wxTAB_TRAVERSAL, _T("ID_PANEL19"));
    M_PanelDraw->SetBackgroundColour(wxColour(20,20,20));
    ...
    G_BorderList = new wxStaticBox(PanelGroups, ID_STATICBOX13, _("   Grupy   "), wxPoint(15,100), wxSize(620,610), 0, _T("ID_STATICBOX13"));
    G_BorderList->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_ACTIVECAPTION));
    G_BorderList->SetBackgroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_ACTIVECAPTION));
    wxFont G_BorderListFont(16,wxDEFAULT,wxFONTSTYLE_NORMAL,wxNORMAL,false,_T("Ubuntu"),wxFONTENCODING_DEFAULT);
    G_BorderList->SetFont(G_BorderListFont);
    G_BorderInfo = new wxStaticBox(PanelGroups, ID_STATICBOX14, _("   Info   "), wxPoint(670,100), wxSize(620,610), 0, _T("ID_STATICBOX14"));
    G_BorderInfo->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_ACTIVECAPTION));
    G_BorderInfo->SetBackgroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_ACTIVECAPTION));
    wxFont G_BorderInfoFont(16,wxDEFAULT,wxFONTSTYLE_NORMAL,wxNORMAL,false,_T("Ubuntu"),wxFONTENCODING_DEFAULT);
    G_BorderInfo->SetFont(G_BorderInfoFont);
    G_ListGroups = new wxListCtrl(PanelGroups, ID_LISTCTRL5, wxPoint(25,130), wxSize(600,570), wxLC_REPORT|wxNO_BORDER|wxTRANSPARENT_WINDOW|wxTAB_TRAVERSAL|wxNO_FULL_REPAINT_ON_RESIZE, wxDefaultValidator, _T("ID_LISTCTRL5"));
    ...
    G_PanelInfo = new wxPanel(PanelGroups, ID_PANEL18, wxPoint(680,128), wxSize(600,570), wxTAB_TRAVERSAL, _T("ID_PANEL18"));
    G_PanelInfo->SetBackgroundColour(wxColour(32,32,32));
    G_LabelEmailCount = new wxStaticText(G_PanelInfo, ID_STATICTEXT154, _("Ilość maili: "), wxPoint(450,15), wxDefaultSize, 0, _T("ID_STATICTEXT154"));
    G_LabelEmailCount->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_SCROLLBAR));
    wxFont G_LabelEmailCountFont(12,wxDEFAULT,wxFONTSTYLE_NORMAL,wxNORMAL,false,_T("Ubuntu"),wxFONTENCODING_DEFAULT);
    G_LabelEmailCount->SetFont(G_LabelEmailCountFont);
    G_LabelName = new wxStaticText(G_PanelInfo, ID_STATICTEXT156, _("Nazwa grupy: "), wxPoint(15,15), wxDefaultSize, 0, _T("ID_STATICTEXT156"));
    G_LabelName->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_SCROLLBAR));
    wxFont G_LabelNameFont(12,wxDEFAULT,wxFONTSTYLE_NORMAL,wxNORMAL,false,_T("Ubuntu"),wxFONTENCODING_DEFAULT);
    G_LabelName->SetFont(G_LabelNameFont);
    G_LabelBoss = new wxStaticText(G_PanelInfo, ID_STATICTEXT155, _("Szef grupy: "), wxPoint(15,40), wxDefaultSize, 0, _T("ID_STATICTEXT155"));
    G_LabelBoss->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_SCROLLBAR));
    wxFont G_LabelBossFont(12,wxDEFAULT,wxFONTSTYLE_NORMAL,wxNORMAL,false,_T("Ubuntu"),wxFONTENCODING_DEFAULT);
    G_LabelBoss->SetFont(G_LabelBossFont);
    G_StaticTextCount = new wxStaticText(G_PanelInfo, ID_STATICTEXT157, _(" - "), wxPoint(530,15), wxDefaultSize, 0, _T("ID_STATICTEXT157"));
    G_StaticTextCount->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_ACTIVECAPTION));
    wxFont G_StaticTextCountFont(12,wxDEFAULT,wxFONTSTYLE_NORMAL,wxNORMAL,false,_T("Ubuntu"),wxFONTENCODING_DEFAULT);
    G_StaticTextCount->SetFont(G_StaticTextCountFont);
    G_StaticTextName = new wxStaticText(G_PanelInfo, ID_STATICTEXT159, _(" - "), wxPoint(120,15), wxDefaultSize, 0, _T("ID_STATICTEXT159"));
    G_StaticTextName->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_ACTIVECAPTION));
    wxFont G_StaticTextNameFont(12,wxDEFAULT,wxFONTSTYLE_NORMAL,wxNORMAL,false,_T("Ubuntu"),wxFONTENCODING_DEFAULT);
    G_StaticTextName->SetFont(G_StaticTextNameFont);
    G_StaticTextBoss = new wxStaticText(G_PanelInfo, ID_STATICTEXT158, _(" - "), wxPoint(120,40), wxDefaultSize, 0, _T("ID_STATICTEXT158"));
    G_StaticTextBoss->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_ACTIVECAPTION));
    wxFont G_StaticTextBossFont(12,wxDEFAULT,wxFONTSTYLE_NORMAL,wxNORMAL,false,_T("Ubuntu"),wxFONTENCODING_DEFAULT);
    G_StaticTextBoss->SetFont(G_StaticTextBossFont);
    StaticLine1 = new wxStaticLine(G_PanelInfo, ID_STATICLINE11, wxPoint(10,70), wxSize(580,-1), wxLI_HORIZONTAL, _T("ID_STATICLINE11"));
    G_ListMembers = new wxListCtrl(G_PanelInfo, ID_LISTCTRL6, wxPoint(10,100), wxSize(580,460), wxLC_REPORT|wxNO_BORDER|wxTRANSPARENT_WINDOW|wxTAB_TRAVERSAL|wxNO_FULL_REPAINT_ON_RESIZE, wxDefaultValidator, _T("ID_LISTCTRL6"));
    G_ListMembers->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_ACTIVECAPTION));
    ...
    U_LabelShowGroup = new wxStaticText(PanelUsembers, ID_STATICTEXT53, _("Pokaż\ngrupę"), wxPoint(710,685), wxDefaultSize, wxALIGN_CENTRE|wxNO_BORDER|wxTRANSPARENT_WINDOW, _T("ID_STATICTEXT53"));
    ...
    U_ImageButtonShowGroup = new wxBitmapButton(PanelUsembers, ID_IMAGEBUTTON9, wxNullBitmap, wxPoint(700,620), wxSize(60,60), wxNO_BORDER|wxTRANSPARENT_WINDOW|wxFULL_REPAINT_ON_RESIZE, wxDefaultValidator, _T("ID_IMAGEBUTTON9"));
    ...
    PanelSettings = new wxPanel(PanelMain, ID_PANEL10, wxPoint(860,20), wxSize(300,210), wxTAB_TRAVERSAL, _T("ID_PANEL10"));
    PanelSettings->Hide();
    PanelSettings->SetBackgroundColour(wxColour(50,50,50));
    Set_Border = new wxStaticBox(PanelSettings, ID_STATICBOX5, wxEmptyString, wxPoint(0,-10), wxSize(300,220), 0, _T("ID_STATICBOX5"));
    ...
    Set_CheckBoxAutoUpdate = new wxCheckBox(PanelSettings, ID_CHECKBOX5, _("Autoaktualizacja z katalogu"), wxPoint(10,85), wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX5"));
    Set_CheckBoxAutoUpdate->SetValue(false);
    Set_CheckBoxAutoUpdate->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_ACTIVECAPTION));
    Set_CheckBoxAutoUpdate->SetBackgroundColour(wxColour(160,160,160));
    wxFont Set_CheckBoxAutoUpdateFont(11,wxDEFAULT,wxFONTSTYLE_NORMAL,wxNORMAL,false,_T("Ubuntu"),wxFONTENCODING_DEFAULT);
    Set_CheckBoxAutoUpdate->SetFont(Set_CheckBoxAutoUpdateFont);
    Set_SliderNotifyTime = new wxSlider(PanelSettings, ID_SLIDER1, 3, 1, 10, wxPoint(20,135), wxSize(260,50), wxSL_HORIZONTAL|wxSL_AUTOTICKS|wxSL_LABELS, wxDefaultValidator, _T("ID_SLIDER1"));
    ...
    Set_LabelNotify = new wxStaticText(PanelSettings, ID_STATICTEXT110, _("Czas wyświetlania powiadomień [s]"), wxPoint(30,115), wxDefaultSize, 0, _T("ID_STATICTEXT110"));
    ...
    Menu1 = new wxMenu();
    MenuItemNew = new wxMenuItem(Menu1, idMenuNew, _("Nowy\tCTRL+N"), _("Creates an empty database"), wxITEM_NORMAL);
    Menu1->Append(MenuItemNew);
    Menu1->AppendSeparator();
    MenuItemOpen = new wxMenuItem(Menu1, idMenuOpen, _("Otwórz pliki\tCTRL+O"), _("Open file/s"), wxITEM_NORMAL);
    Menu1->Append(MenuItemOpen);
    MenuItemOpenFolder = new wxMenuItem(Menu1, idMenuOpenFolder, _("Otwórz folder\tCTRL+SHIFT+O"), _("Open all files in a folder"), wxITEM_NORMAL);
    Menu1->Append(MenuItemOpenFolder);
    Menu1->AppendSeparator();
    MenuItemSave = new wxMenuItem(Menu1, idMenuSave, _("Zapisz\tCTRL+S"), _("Save your work"), wxITEM_NORMAL);
    Menu1->Append(MenuItemSave);
    Menu1->AppendSeparator();
    MenuItemQuit = new wxMenuItem(Menu1, idMenuQuit, _("Zamknij\tAlt-F4"), _("Quit the application"), wxITEM_NORMAL);
    Menu1->Append(MenuItemQuit);
    MenuBar1->Append(Menu1, _("&Plik"));
    Menu2 = new wxMenu();
    MenuItemImportBin = new wxMenuItem(Menu2, idMenuImportBin, _("Import pliku binarnego"), _("Load database from a binary file"), wxITEM_NORMAL);
    Menu2->Append(MenuItemImportBin);
    Menu2->AppendSeparator();
    MenuItemExportBin = new wxMenuItem(Menu2, idMenuExportBin, _("Eksport do pliku binarnego"), _("Stores databse in a binary file"), wxITEM_NORMAL);
    Menu2->Append(MenuItemExportBin);
    MenuItemExportTxt = new wxMenuItem(Menu2, idMenuExportText, _("Eksport do plików tekstowych"), _("Copy database to a text file"), wxITEM_NORMAL);
    Menu2->Append(MenuItemExportTxt);
    MenuBar1->Append(Menu2, _("&Import/Eksport"));
    Menu3 = new wxMenu();
    MenuItemRecursive = new wxMenuItem(Menu3, idMenuRecursive, _("Wczytywanie rekursywne\tCTRL+SHIFT+R"), _("On/off recursive folder loading"), wxITEM_CHECK);
    Menu3->Append(MenuItemRecursive);
    MenuItemConfirm = new wxMenuItem(Menu3, idMenuDelConfirm, _("Potwierdzenia usuwania\tCTRL+SHIFT+C"), _("On/off confirmation prompt when trying to delete a record"), wxITEM_CHECK);
    Menu3->Append(MenuItemConfirm);
    MenuItemConfirm->Check(true);
    MenuItemEncryption = new wxMenuItem(Menu3, idMenuDatabaseEncryption, _("Szyfrowanie bazy danych\tCTRL+SHIFT+E"), _("On/off database encyption"), wxITEM_CHECK);
    Menu3->Append(MenuItemEncryption);
    MenuItemAutoUpdate = new wxMenuItem(Menu3, idMenuAutoUpdate, _("Autoaktualizacja z katalogu\tCTRL+SHIFT+A"), _("On/off auto update"), wxITEM_CHECK);
    Menu3->Append(MenuItemAutoUpdate);
    ...
    MenuBar1->Append(Menu3, _("Ustawienia"));
    Menu4 = new wxMenu();
    ...
    Connect(ID_CHECKBOX5,wxEVT_COMMAND_CHECKBOX_CLICKED,(wxObjectEventFunction)&AisdiRelationsFrame::OnSet_CheckBoxAutoUpdateClick);
    ...
    Connect(idMenuAutoUpdate,wxEVT_COMMAND_MENU_SELECTED,(wxObjectEventFunction)&AisdiRelationsFrame::OnMenuItemAutoUpdateSelected);
...
{
    if (MenuItemAutoUpdate->IsCheckable())
        P_Title->SetAutoUpdate(MenuItemAutoUpdate->IsChecked());
    Set_CheckBoxAutoUpdate->SetValue(MenuItemAutoUpdate->IsChecked());
}
